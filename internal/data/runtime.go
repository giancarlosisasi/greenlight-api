...
// Implement UnmarshalJSON() method on the Runtime type so that it satisfies the
...
func (r *Runtime) UnmarshalJSON(jsonValue []byte) error {
	...
	//Convert the int 32 to Runtime type and assign this to the receiver. Note that we
